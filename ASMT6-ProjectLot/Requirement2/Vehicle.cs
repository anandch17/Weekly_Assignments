...
namespace Requirement2
{
    public class Vehicle
    {
		...
		{
			return $"Registration No: {_registrationNo}, Name: {_name}, Type: {_type}, Weight: {_weight:F1},Ticket no is {_ticket.TicketNo},parkedTime is {_ticket.ParkedTime} cost is {_ticket.Cost:F1}";
        }
